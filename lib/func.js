...
return moment.tz('America/perú_City').locale('id').format(format)
}
}
...
const time = moment.tz('America/perú_City').format('DD/MM HH:mm:ss')
let d = new Date
let locale = 'id'
...
m.reply = async (text, chatId = m.chat, options = {}) => {
    if (Buffer.isBuffer(text)) {
        return client.sendMedia(chatId, text, 'file', '', m, { ...options });
    } else {
let canalId = ["120363422169517881@newsletterr",
...
let canalNombre = ["MagnosBot | CHANNEL",
"𝐒𝐀𝐍𝐓𝐀𝐅𝐋𝐎𝐖 𝐁𝐎𝐓 | ° 𝘊𝘏𝘈𝘕𝘕𝘌𝘓- 𝗢𝗙𝗜𝗖𝗜𝗔𝗟🧪꙰⃟⸙",
"꙰⃟⚽  RIN ITOSHI | ° ᴄʜᴀɴɴᴇʟ - Official ⚽꙰⃟⸙",
"MagnosBot | CHANNEL",
"𝐒𝐀𝐍𝐓𝐀𝐅𝐋𝐎𝐖 𝐁𝐎𝐓 | ° 𝘊𝘏𝘈𝘕𝘕𝘌𝘓- 𝗢𝗙𝗜𝗖𝗜𝗔𝗟🧪꙰⃟⸙ ✨",
"꙰⃟⚽  RIN ITOSHI | ° ᴄʜᴀɴɴᴇʟ - Official ⚽꙰⃟⸙",
"MagnosBot | CHANNEL"
...
const contextInfo = {
        ...
        return client.sendText(chatId, text, m, messageOptions);
    }
};
...
previewType: `PHOTO`,
thumbnailUrl: 'https://i.postimg.cc/SKT0nbDk/IMG-20250909-WA0061.jpg', 
sourceUrl: 'https://github.com/OmarGranda/MagnosBot' }}
}))
...
let prep = generateWAMessageFromContent(jid, { extendedTextMessage: { text: text, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363422169517881@newsletter', serverMessageId: '', newsletterName: `MagnosBot` }, externalAdReply: { title: `Magnosbot-MD 💫`, body: 'Zam', mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: 'https://i.postimg.cc/NGrhjVTv/IMG-20250909-WA0062.jpg', sourceUrl: 'https://github.com/OmarGranda/MagnosBot' }}}}, { quoted: m })
...
let prep = generateWAMessageFromContent(jid, { extendedTextMessage: { text: text, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363422169517881@newsletter', serverMessageId: '', newsletterName: `MagnosBot` }, externalAdReply: { title: `MagnosBot-MD 💫`, body: 'Zam', mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: 'https://i.postimg.cc/F1tDYDM9/IMG-20250909-WA0060.jpg', sourceUrl: 'https://github.com/OmarGranda/MagnosBot' }}}}, { quoted: null })
return client.relayMessage(jid, prep.message, { messageId: prep.key.id })
}
